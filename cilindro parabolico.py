...
class PlotWin:
    ...
    def showPlot(self ,pA, limS, limI, A):  
        ...
        lAxis = Axes3D(lFig) 
        lAxis.plot_surface(XVecG, YVecG, ZMat, rstride=1, cstride=1, cmap='bone')
